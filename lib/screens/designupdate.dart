                    ...
                    Padding(
                      ...
                      child: TextFormField(style: TextStyle(color: Colors.white, fontFamily: fontfamily),
                        decoration: InputDecoration(
                          ...
                          hintText: 'Userame:',hintStyle: TextStyle(color: Colors.white),
                    ...
                    Padding(
                      ...
                      child: TextFormField(style: TextStyle(color: Colors.white, fontFamily: fontfamily),
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.email_outlined,color: Color(0xFFA6B3BC),),
                    ...
                    Padding(
                      ...
                      child: TextFormField(style: TextStyle(color: Colors.white, fontFamily: fontfamily),
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.phone,color: Color(0xFFA6B3BC),),
                    ...
                    Padding(
                      ...
                      child: TextFormField(style: TextStyle(color: Colors.white, fontFamily: fontfamily),
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.supervised_user_circle_sharp,color: Color(0xFFA6B3BC),),
                    ...
                    Padding(
                      ...
                      child: TextFormField(style: TextStyle(color: Colors.white, fontFamily: fontfamily),
                        decoration: InputDecoration(
                          ...
                          fillColor: Colors.white,
                          hintText: 'Country:',hintStyle: TextStyle(color: Colors.white),
                          prefixIcon: Icon(Icons.home_work_outlined,color: Color(0xFFA6B3BC),),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: Colors
                                        .white)),
                            child: Center(child: Text('Update',textAlign: TextAlign.center,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),)),
                          ),
                        ),
                      ],
                    ),
