      ...
      child: Stack(
        children:[ Scaffold(
          ...
          body:ListView(padding: EdgeInsets.symmetric(horizontal: 20),
            children: [
              SizedBox(height: 20,),
              Text("Billing details",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Color(0xFFA19895)),),
              SizedBox(height:10),
              Text("First Name*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              ...
              SizedBox(height:10),
              Text("Last Name*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
              ...
              SizedBox(height:10),
              Text("Address1*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
              ...
              SizedBox(height:10),
              Text("Address2*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
              ...
              SizedBox(height:10),
              Text("City*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
                  controller: _city,
                  validator: Validators.required(
              ...
              SizedBox(height:10),
              Text("State*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
                  controller: _state,
                  validator: Validators.required(
              ...
              SizedBox(height:10),
              Text("Post Code*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
              ...
              SizedBox(height:10),
              Text("Country*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
                  controller: _country,
                  validator: Validators.required(
              ...
              SizedBox(height:10),
              Text("Email*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
                  controller: _email,
                  validator: Validators.required(
              ...
              SizedBox(height:10),
              Text("Phone Number*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: TextFormField(style: TextStyle(color: Colors.black),
                  controller: _phone,
                  validator: Validators.required(
              ...
              SizedBox(height: 20,),
              Text("Ship address",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Color(0xFFA19895)),),
              SizedBox(height:10),
              Text("First Name*",style: TextStyle(color: Color(0xFFA19895),fontSize: 16),),
              Container(color: Colors.white,height: 40,
                child: Center(
              ...
              ElevatedButton(
                ...
                // if(formKey.currentState.validate())
                  Navigator.of(context)
                      .pushReplacement(
                      MaterialPageRoute(builder: (context) => ShopPay(_firstname.text,_lastname.text,_address1.text,_address2.text,
                      _city.text,_state.text,_postcode.text,_country.text,_email.text,_phone.text,_shipname.text,_shiplastname.text,
                      _shipaddress1.text,_shipaddress2.text,_shipcity.text,_shipsate.text,_shippostcode.text,_shipcountry.text,)));
                  },
                child: Text(
                  " Proceed to Pay",
                  style: TextStyle(
