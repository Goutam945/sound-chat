...
class _Scheduledesign extends State<scheduledesign> {
  ...
  int day=6;
  int weekday;
  bool _hasBeenPressed = true,_hasBeenPressed1 = true,_hasBeenPressed2 = true,_hasBeenPressed3 = true,
  _hasBeenPressed4 = true,_hasBeenPressed5 = true,_hasBeenPressed6 = true;
  @override
  void initState() {
      ...
      body:(superheros_length != null) ? ListView(
        children: [
            ...
            Row(
                    children: [
                     // for (int i = 0; i < jsonDecode(data)['data'].length; i++)
                        for (int j = 0; j < jsonDecode(data)['data'][weekday]['shows'].length; j++)
                          SizedBox(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                      ...
                                      child: Center(
                                          child: Text(
                                        jsonDecode(data)['data'][weekday]['shows'][j]
                                                ['show_name']
                                            .toString(),
                                        style: TextStyle(
                                          color: Colors.white,
         ...
         // for (int i = 6; i < 7; i++)
            ...
            for (int j = 0; j < jsonDecode(data)['data'][day]['shows'].length; j++)
          Column(
            children: [
              Padding(
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Padding(
                          ...
                          child: Text(jsonDecode(data)['data'][day]['shows'][j]['show_name'], style: TextStyle(color: Colors.white, fontSize: 14,),
                          ),
                        ),
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text(jsonDecode(data)['data'][day]['post_title'],
                                style: TextStyle(
                                    color: Color(0xFF645D5D), fontSize: 12),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 40, top: 5),
                              child: Text(
                                jsonDecode(data)['data'][day]['shows'][j]['show_start_date'],
                                style: TextStyle(
                                    color: Color(0xFF645D5D), fontSize: 12),
                              ),
                            ),
